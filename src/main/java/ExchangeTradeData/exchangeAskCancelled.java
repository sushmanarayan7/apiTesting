...
public class exchangeAskCancelled extends DriverCreation
{
    ...
    public void AskCancelled(String apikey,String from,String max,String offset)
    {
        ...
        Response response=httpRequest.header("Authorization",apikey).queryParameter("from",from).
                ...
                get("/user/exchange/ask/cancelled");
