...
public class bankFiatWithdrawCompleted extends DriverCreation
{
    ...
    public void FiatWithdrawCompleted(String apikey,String from,String max,String offset)
    {
        ...
        Response response=httpRequest.header("Authorization",apikey).queryParameter("from",from).
                ...
                get("/user/exchange/bank/fiat/withdraw/completed");
