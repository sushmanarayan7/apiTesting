...
public class bankFiatBalanceTotal extends DriverCreation
{
    ...
    public void FiatBalanceTotal(String key)
    {
        RequestSpecification httpRequest = RestAssured.given();
        Response response=httpRequest.parameter("key", key).header("Authorization","{key}").get("/user/exchange/bank/fiat/balance/total");
