...
public class bankCoinWithdrawCancelled extends DriverCreation
{
    ...
    public void CoinWithdrawCancelled(String apikey,String from,String max, String offset)
    {
        ...
        Response response=httpRequest.header("Authorization",apikey).queryParameter("from",from).
                ...
                get("/user/exchange/bank/coin/withdraw/cancelled");
