...
public class bankCoinBalanceTotal extends DriverCreation
{
    ...
    public  void CoinBalanceTotal(String key)
    {
        RequestSpecification httpRequest = RestAssured.given();
        Response response=httpRequest.parameter("key", key).header("Authorization","{key}").get("/user/exchange/bank/coin/balance/total");
