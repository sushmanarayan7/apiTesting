...
public class bankCoinBalanceAvailable extends DriverCreation
{
    ...
    public void CoinBalanceAvailable(String key)
    {
        RequestSpecification httpRequest = RestAssured.given();
        Response response=httpRequest.parameter("key", key).header("Authorization","{key}").get("/user/exchange/bank/coin/balance/available");
