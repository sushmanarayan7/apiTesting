...
public class bankCoinWithdrawUnverified extends DriverCreation
{
    ...
    public void CoinWithdrawUnverified(String apikey,String from,String max,String offset)
    {
        ...
        Response response=httpRequest.header("Authorization",apikey).queryParameter("from",from).
                ...
                get("/user/exchange/bank/coin/withdraw/unverified");
